...
router.post('/invitation/:invitationID/reject', (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        let { invitationID } = req.params;
        let invitaion = yield joinRequestsController_1.default.getInstance().getItem(invitationID);
        let data = JSON.parse(util_1.decryptData(req.body)).data;
...
router.get('/invitaions', (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        let invitaionsWihExtra = yield util_1.asyncMap(invitaions, (invit) => __awaiter(this, void 0, void 0, function* () {
            let project;
            try {
        ...
        res.json({
            data: util_1.encryptData(invitaionsWihExtra)
        });
    }
    catch (e) {
        res.sendStatus(500);
